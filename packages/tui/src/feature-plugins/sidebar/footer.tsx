      ...
      <Show when={show()}>
        ...
        >
          ...
          <box flexGrow={1} gap={1}>
            ...
            <text fg={theme().textMuted}>OpenCode có sẵn các model miễn phí để bạn bắt đầu ngay.</text>
            <text fg={theme().textMuted}>
              Kết nối từ hơn 75 provider để dùng các model khác như Claude, GPT, Gemini...
            </text>
            <box flexDirection="row" gap={1} justifyContent="space-between">
              <text fg={theme().text}>Kết nối provider</text>
